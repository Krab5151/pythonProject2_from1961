...
# TODO  Куча мала, в словаре transition все слова из document = [], поочерёдно key и value
bigrams = zip(
    document, document[1:]
...
# TODO  пример, подразумеваем что через requests.get(url) сайт получен
