...
def foo(ar):
    ...
    less = [x for x in ar[1:] if x < pivot]  # Уменьшение аргумента ar, массив в слева от опорного элемента
    greater = [x for x in ar[1:] if x > pivot]  # Уменьшение аргумента ar, но массив в справа от опорного элемента
